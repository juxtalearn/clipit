<?php 
	...
	*/
	...
	$spanish = array(
		...
		// entity names
		'item:object:custom_profile_field' => 'Campo perfil personalizado',
		...
		'profile_manager:settings:other' => 'Otros',
		...
		'profile_manager:admin:metadata_hint' => 'Indicio',
		'profile_manager:admin:metadata_description' => 'Descripción',
		'profile_manager:admin:metadata_label_translated' => 'Etiqueta (Traducido)',
		'profile_manager:admin:metadata_label_untranslated' => 'Etiqueta (Sin traducir)',
		'profile_manager:admin:metadata_options' => 'Opciones (separado por coma)',
		'profile_manager:admin:field_type' => "Tipo del campo",
		...
		'profile_manager:categories:add' => "Añadir una nueva categoría",
		...
		'profile_manager:profile_types:add' => "Añadir un nuevo tipo de perfil",
		...
		'profile_manager:user_summary_control:options:spacers' => "Espaciadores",
		...
		'profile_manager:admin:users:inactive:last_login' => "Última sesión antes de",
		...
		// Reset
		'profile_manager:actions:reset:description' => 'Elimina todos los campos de perfil personalizados',
		...
		'profile_manager:actions:reset:success' => 'Restablecido con éxito',
		...
		'profile_manager:actions:restore:success' => "Restaurado con éxito",
		...
		// edit
		'profile_manager:actions:edit:error:unknown' => 'Error al coger los datos del campo de perfil',
		...
		// widgets
		'widgets:profile_completeness:title' => 'Perfil completo',
		'widgets:profile_completeness:description' => 'Mostrar el perfil completo',
		'widgets:profile_completeness:view:tips' => 'Tip! Update your %s to improve the Profile Completeness.',
		'widgets:profile_completeness:view:complete' => '¡Enhorabuena! Su perfil está 100% completo!',
		
		'widgets:register:title' => "Registro",
		'widgets:register:description' => "Mostrar un cuadro de registro",
		'widgets:register:loggedout' => "Es necesario estar conectado para utilizar este widget",
	
		// datepicker		
		'profile_manager:datepicker:trigger' => 'Seleccionar una fecha',
		...
		'profile_manager:profile:edit:custom_profile_type:label' => "Seleccione el tipo de perfil",
