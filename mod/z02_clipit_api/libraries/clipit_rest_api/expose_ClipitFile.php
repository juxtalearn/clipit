    ...
    expose_function(
        ...
        array(
            "id" => array(
                "type" => "int",
                "required" => true)),
        "Get the Activity this File is inside of.",
        'GET', false, true);
    expose_function(
        $api_suffix . "get_site",
        ...
        array(
            "id" => array(
                "type" => "int",
                "required" => true)),
        "Get the Site this File is inside of.",
        'GET', false, true);
    expose_function(
        $api_suffix . "add_tags",
