    ...
    expose_function(
        ...
        array(
            ...
            "storyboard_array" => array(
                "type" => "array",
                "required" => true)),
        "Add Storyboards by Id to a Post",
        "POST", false, true);
    expose_function(
        ...
        array(
            ...
            "storyboard_array" => array(
                "type" => "array",
                "required" => true)),
        "Set Storyboards by Id to a Post",
        "POST", false, true);
    expose_function(
        ...
        array(
            ...
            "storyboard_array" => array(
                "type" => "array",
                "required" => true)),
        "Removes Storyboards by Id from a Post",
        "POST", false, true);
    expose_function(
    ...
    expose_function(
        ...
        array(
            ...
            "video_array" => array(
                "type" => "array",
                "required" => true)),
        "Removes Videos by Id from a Post",
        "POST", false, true);
    expose_function(
