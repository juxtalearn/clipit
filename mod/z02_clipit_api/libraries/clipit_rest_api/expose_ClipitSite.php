...
function expose_site_functions() {
    ...
    expose_function($api_suffix . "get_files",
        ...
        false,
        true);
    expose_function($api_suffix . "add_resources",
        $class_suffix . "add_resources",
        array("resource_array" => array("type" => "array", "required" => true)),
        "Add Resources by Id to the Site",
        "POST",
        false,
        true);
    expose_function($api_suffix . "set_resources",
        $class_suffix . "set_resources",
        array("resource_array" => array("type" => "array", "required" => true)),
        "Set Resources by Id to the Site",
        "POST",
        false,
        true);
    expose_function($api_suffix . "remove_resources",
        $class_suffix . "remove_resources",
        array("resource_array" => array("type" => "array", "required" => true)),
        "Removes Resources by Id from the Site",
        "POST",
        false,
        true);
    expose_function($api_suffix . "get_resources",
        $class_suffix . "get_resources",
        null,
        "Gets Resources from the Site",
        "GET",
        false,
        true);
    ...
    expose_function($api_suffix . "get_pub_files",
        ...
        false,
        true);
    expose_function($api_suffix . "add_pub_resources",
        $class_suffix . "add_pub_resources",
        array("resource_array" => array("type" => "array", "required" => true)),
        "Add Resources by Id to the Public Scope",
        "POST",
        false,
        true);
    expose_function($api_suffix . "set_pub_resources",
        $class_suffix . "set_pub_resources",
        array("resource_array" => array("type" => "array", "required" => true)),
        "Set Resources by Id to the Public Scope",
        "POST",
        false,
        true);
    expose_function($api_suffix . "remove_pub_resources",
        $class_suffix . "remove_pub_resources",
        array("resource_array" => array("type" => "array", "required" => true)),
        "Removes Resources by Id from the Public Scope",
        "POST",
        false,
        true);
    expose_function($api_suffix . "get_pub_resources",
        $class_suffix . "get_pub_resources",
        null,
        "Gets Resources from the Public Scope",
        "GET",
        false,
        true);
}
