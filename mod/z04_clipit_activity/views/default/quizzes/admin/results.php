...
switch($type = get_input('type')){
    ...
    case 'chart':
        ...
        <script>
            ...
            $(function(){
                var ch = document.getElementById("canvas-chart-<?php echo $user_id;?>").getContext("2d");
        ...
        <canvas id="canvas-chart-<?php echo $user_id;?>" style="background: rgb(236, 247, 252);padding: 10px;width: 100% !important;"  width="800" height="500"></canvas>
    <?php
        break;
                ...
                <li class="list-item answer">
                    <div class="pull-right">
                        ...
                        echo elgg_view('output/url', array(
                            'title' => elgg_echo('quiz:teacher_annotation'),
                            'text' => '',
                            'data-target' => '#question-result-'.$question->id.'-'.$user_id,
                            'data-toggle' => 'collapse',
                            'href' => 'javascript:;',
                            'class' => 'fa fa-edit btn btn-xs btn-border-blue btn-icon',
                            'onclick' => '$(this).closest(\'.answer\').find(\'.annotate\').toggle()',
                        ...
                        ?>
                        <i class="btn fa fa-angle-down blue btn-icon"
                           data-target="#question-result-<?php echo $question->id;?>-<?php echo $user_id;?>"
                           data-toggle="collapse"></i>
                    </div>
                    <span class="pull-left margin-right-5">
                        <?php if(!$result):?>
                    ...
                    <div class="clearfix"></div>
                    <div id="question-result-<?php echo $question->id;?>-<?php echo $user_id;?>"
                         class="question-result collapse"
                         style="background: #fff;padding: 5px 10px;margin-top: 5px;">
                        <?php switch($question->option_type):
                            case ClipitQuizQuestion::TYPE_SELECT_MULTI:
