...
<div class="margin-bottom-20 result">
    <label class="inline-block" style="padding-right: 10px;">
        <input type="checkbox" <?php echo $vars['checked'] == true ? 'checked' : '';?> name="question[<?php echo $id;?>][select_multi][<?php echo $id_input;?>][correct]" value="1" class="inline-block">
    </label>
    ...
    <?php echo elgg_view("input/text", array(
        'name' => 'question['.$id.'][select_multi]['.$id_input.'][value]',
