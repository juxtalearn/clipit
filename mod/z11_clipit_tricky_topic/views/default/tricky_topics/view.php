...
?>
    <tr>
        ...
        <td>
            <strong><a class="margin-0"><?php echo $tricky_topic->name;?></a></strong>
        </td>
        <td>
            <small>
                <div>
        ...
        <td>
            <small class="show">10 Activities</small>
            <small class="show"><?php echo count($quizzes);?> Quizzes</small>
            <small class="show"><?php echo count($tricky_topic->tag_array);?> <?php echo elgg_echo('tags');?></small>
        </td>
    </tr>
<?php endforeach;?>
</table>