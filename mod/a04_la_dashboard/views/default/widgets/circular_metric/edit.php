...
if ($clipit_user->role == ClipitUser::ROLE_ADMIN) {
    echo elgg_view('widgets/circular_metric/edit_admin', $vars);
} else if ($clipit_user->role == ClipitUser::ROLE_TEACHER) {
    echo elgg_view('widgets/circular_metric/edit_teacher', $vars);
} else if ($clipit_user->role == ClipitUser::ROLE_STUDENT) {
    echo elgg_view('widgets/circular_metric/edit_student', $vars);
}