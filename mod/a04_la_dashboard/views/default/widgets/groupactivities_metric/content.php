...
if (!isset($widget->activity_id) || $widget->activity_id == elgg_echo('la_dashboard:widget:quizresult:selectactivity')) {
    ...
    $metrics_data = array("metric_id" => "GroupActivities", "context" => array("activity_id" => $widget->activity_id), "target" => $widget_id);
    ...
    <script>
        elgg.get('ajax/view/metrics/metric', {
            ...
            success: function (data) {
                ...
                var text = $("#activity_dropdown-<?php echo $widget_id?>  option:selected").text();
