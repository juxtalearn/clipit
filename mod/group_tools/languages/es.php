<?php 
	...
	$english = array(
		...
		// general
		'group_tools:decline' => "Rechazar",
		'group_tools:revoke' => "Revoke",
		'group_tools:add_users' => "Añadir usuarios directamente",
		'group_tools:in' => "in",
...
%s",
		...
		'group_tools:groups:invite' => "Invitar o Añadir usuarios",
		
		'group_tools:group:invite:friends:select_all' => "Seleccionar todos los amigos",
		'group_tools:group:invite:friends:deselect_all' => "Desmarcar todos los amigos",
		
		'group_tools:group:invite:users' => "Encontrar usuario(s)",
		'group_tools:group:invite:users:description' => "Introduzca el nombre o el nombre de usuario de un usuario del sitio y seleccionalo",
		...
		'group_tools:group:invite:csv' => "Cargar CSV",
		...
		'group_tools:group:invite:add:confirm' => "¿Está seguro de que desea añadir directamente a estos usuarios?",
		
		'group_tools:group:invite:resend' => "Reenviar invitaciones a los usuarios que ya han sido invitados",
