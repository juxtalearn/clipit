<?php
/**
 * Elgg developer tools Portuguese language file.
 *
 */
...
$portuguese = array(
    ...
    'admin:developers:settings' => 'Configuracoes',
    ...
    'theme_preview:buttons' => 'Butoes',
    'theme_preview:components' => 'Componentes',
    'theme_preview:forms' => 'Formularios',
    'theme_preview:grid' => 'Grelha',
    'theme_preview:icons' => 'Icones',
    'theme_preview:modules' => 'Modulos',
    'theme_preview:navigation' => 'Navegacao',
