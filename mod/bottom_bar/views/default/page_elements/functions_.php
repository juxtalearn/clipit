...
function restructureChatBoxes() {
    ...
    if ($("#chatbox_"+chatboxtitle).length > 0) {
        ...
        .addClass("chatbox")
        .html('<div class="chatboxhead"><div class="chatboxtitle">' + chatwithname + '</div><div class="chatboxoptions"><a href="javascript:void(0)" onclick="javascript:bb_minimise(\''+chatboxtitle+'\')">-</a> <a href="javascript:void(0)" onclick="javascript:bb_maximize(\''+chatboxtitle+'\')">+</a>  <a href="javascript:void(0)" onclick="javascript:bb_close(\''+chatboxtitle+'\')">X</a></div><br clear="all"/></div><div class="chatboxcontent"></div><div class="chatboxinput"><input type="text" style="height: 25px;width: 100%;box-sizing: border-box;box-sizing: border-box;-moz-box-sizing: border-box;margin-bottom: 0px;" name="chat_' + chatboxtitle + '"  onkeydown="javascript:return checkChatBoxInputKey(event,this,\''+chatboxtitle+'\');"></input></div>')
	    .appendTo($("body"));
