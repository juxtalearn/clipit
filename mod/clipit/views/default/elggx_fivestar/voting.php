...
<div <?php echo $outerId; ?> class="fivestar-ratings-<?php echo $guid . $subclass; ?>">
    <form id="fivestar-form-<?php echo $guid; ?>" style="width: auto" action="<?php echo $vars['url']; ?>action/elggx_fivestar/rate" method="post">
    ...
    <?php if (!$vars['min']): ?>
        ...
        <p <?php echo $ratingText; ?>>
            <span id="fivestar-rating-<?php echo $guid; ?>"><?php echo $rating['rating']; ?></span>/<?php echo $stars." ".elgg_echo("elggx_fivestar:lowerstars")." ("; ?><span id="fivestar-votes-<?php echo $guid; ?>"><?php echo $rating['votes'];?></span><?=" ".elgg_echo("elggx_fivestar:votes").")"; ?>
        </p>
    <?php endif; ?>
</div>
