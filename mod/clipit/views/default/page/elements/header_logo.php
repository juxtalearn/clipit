...
<div class="span8 pull-right">
    <ul class="nav nav-pills pull-right">
        <?php if (elgg_is_logged_in()) { ?>
            <li <?php if ($context == "messages") echo "class='active'"; ?>><a href="<?php echo $url; ?>messages/inbox/<?php echo $username; ?>"><text style="color:#fff;"><?php echo $messages; ?></text> <?=elgg_echo("messages");?></a></li>
