...
<tbody><tr>
    ...
    <td class="col-md-9 file-info">
        <h4>
            <a href="http://juxtalearn.org/sandbox/clipit_befe/clipit_activity/74/group/files/view/219" title="Archivo de muestra">Archivo de muestra</a>            </h4>
        <small class="show">
            <strong>
                PDF document
            </strong>
        ...
        <p>
            Esto es un archivo de muestra en clipit            </p>
