...
class ClipitFile {
    ...
    static function exposeFunctions() {
        expose_function("clipit.file.getProperty", "ClipitFile::getProperty", array(
            "id" => array(
                "type" => "integer",
                "required" => true),
            "prop" => array(
        ...
        expose_function("clipit.file.setProperty", "ClipitFile::setProperty", array(
            "id" => array(
                "type" => "integer",
                "required" => true),
            "prop" => array(
