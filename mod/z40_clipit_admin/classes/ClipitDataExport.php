...
class ClipitDataExport{
    ...
    static function export_all($filename = ""){
        ...
        $file_array[] = static::export_class_to_excel("ClipitRemoteActivity");
        $file_array[] = static::export_class_to_excel("ClipitRemoteFile");
        $file_array[] = static::export_class_to_excel("ClipitRemoteSite");
        $file_array[] = static::export_class_to_excel("ClipitRemoteText");
