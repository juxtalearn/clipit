...
//                            'description' => $item->description,
//                            'url'  => "z04_clipit_activity/{$activity->id}/group/discussion/view/{$msg_parent->id}#reply_{$item->id}",
//                        ),
//                    );
//                    // Second level reply
//                    if(!$msg_parent->name){
...
//                        $params['item']['url'] = "z04_clipit_activity/{$activity->id}/group/discussion/view/{$msg_parent->id}#reply_{$item->id}";
//                    }
//
//                }
                break;
...
//                //'icon' => "$item->icon",
//                'icon' => "file-o",
//                'url' => "z04_clipit_activity/{$activity->id}/group/files/view/{$item->id}",
//            )
//        );
//        return $params;
//    });
...
//                'url' => "z04_clipit_activity/{$activity->id}/group/discussion/view/{$object->id}",
//            )
//        );
//        return $params;
//    });
...
//                'description' => $object->description,
//                'icon' => "ICONO!!",
//                'url' => "z04_clipit_activity/{$activity->id}/group/files/view/{$object->id}",
//            )
//        );
//        return $params;
//    });
...
//            'item' => array(
//                'name' => $object->name,
//                'url' => 'z04_clipit_activity/%d/group/activity_log',
