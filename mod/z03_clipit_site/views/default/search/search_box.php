...
<form class="<?php echo $class; ?>" action="<?php echo elgg_get_site_url();?>explore/search" method="GET">
    <div class="input-group">
        <input type="text" class="form-control" aria-label="<?php echo elgg_echo('search');?>" size="21" name="<?php echo elgg_echo('search');?>" value="<?php echo $display_query; ?>" placeholder="<?php echo elgg_echo('search');?>" />
